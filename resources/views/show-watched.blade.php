        ...
        <div class="mx-auto row">
            <ul class="col-12">
                ...
                @foreach ($seasons as $season)
                    ...
                    <li class="ml-4 mt-4 text-left">
                        <h2 class="">{{ $season->name }}</h2>
                    </li>
                    <br>
                    <ul class="col-sm-12 d-flex flex-wrap justify-content-evenly mr-3 ml-3 mt-3">
                        ...
                        @foreach ($episodes as $episode)
                            <div class="episodes-box mb-2 mt-3 mr-3" style="width: 342px">
